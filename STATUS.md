...
النسبة الفعلية مقارنة بـ Windows GM82 الكامل: **~42% (أقل من 50%)**

## 📌 ملخص الوضع الحالي
- النواة تتطور كنسخة أولية على Host (تفك GMK، تمارس Soft Render، تحاكي فيزياء ماريو، تنفذ أفعال DnD وعبارات GML والمتغيرات الضمنية `bbox_*` وهياكل `ds_list`, `ds_map`).
- النسبة الإجمالية مقارنة بالمحرك الكامل لويندوز هي **42%**.
