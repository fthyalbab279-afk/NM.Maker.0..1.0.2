...
current_task: gles_one_texture
last_result: PASS
last_test_log: SCRIPT_SCAN_TEST_SUITE_PASS: Total sample files passing script decode test = 4/4; SOUND_PLAYBACK_TEST_PASS: Decoded 3 sounds and queued playback successfully
